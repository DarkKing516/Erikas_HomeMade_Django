...
DATABASES = {
    ...
    'default': dj_database_url.config(
        default = 'postgresql://erikas_homemade_a8bd_user:B8rteIVVhH2qACwPdhqT9mZchYVfdNDS@dpg-crec520gph6c73eqv050-a.oregon-postgres.render.com/erikas_homemade_a8bd',
        conn_max_age = 600
    )
}
