...
('Editar Estado Tipo Servicios', 'A'),
('Eliminar Tipo Servicios', 'A'),
('Editar Estado Tipo de Servicios', 'A'),
('Listar Pedidos', 'A'),
...
-- Insertar Tipo Producto de ejemplo
INSERT INTO `tipo_productos` (`idTipo_Producto`, `nombre_producto`, `estado_producto`) VALUE
(NULL, 'Muñecos', 'Activo'),
(NULL, 'Manualidades', 'Activo'),
(NULL, 'Accesorios', 'Activo'),
(NULL, 'Vestidos', 'Activo'),
(NULL, 'Uniformes', 'Activo');

-- Insertar Tipo Servicio de ejemplo
INSERT INTO `tipo_servicios` (`idTipo_Servicio`, `nombre_tipoServicio`, `estado_tipoServicio`) VALUES
(NULL, 'Hacer Prendas', 'Activo'),
(NULL, 'Hacer Manualidades', 'Activo'),
(NULL, 'Hacer Arreglo', 'Activo'),
(NULL, 'Coser Prenda', 'Activo'),
(NULL, 'Hacer uniforme', 'Activo');
...
(NULL, '2024-05-15 19:55:00.171933', '2024-05-15 19:50:00.000000', 'Prueba uwu 2', '80000.00', '15200.00', '95200.00', 'pedidos/EvidenciaFlutter.png', 'En proceso', '2'),
(NULL, '2024-05-15 19:56:00.171933', '2024-05-15 19:51:00.000000', 'Prueba uwu 3', '70000.00', '13300.00', '83300.00', 'pedidos/EvidenciaFlutter.png', 'Hecho', '2'),
(NULL, '2024-05-15 19:57:00.171933', '2024-05-15 19:52:00.000000', 'Prueba uwu 4', '60000.00', '11400.00', '71400.00', 'pedidos/EvidenciaFlutter.png', 'Entregado', '2'),
(NULL, '2024-05-15 19:57:00.171933', '2024-05-15 19:52:00.000000', 'Prueba 1234', '60000.00', '11400.00', '71400.00', 'pedidos/EvidenciaFlutter.png', 'Entregado', '2'),
(NULL, '2024-05-15 19:58:00.171933', '2024-05-15 19:53:00.000000', 'Prueba uwu 5', '50000.00', '9500.00', '59500.00', 'pedidos/EvidenciaFlutter.png', 'Cancelado', '2');
